...
import hr.tvz.android.notesuru.databinding.ActivityDetailBinding;
import hr.tvz.android.notesuru.databinding.ActivityMainBinding;

public class Detail extends AppCompatActivity {
    long id;
    ActivityDetailBinding bindingActivity;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        bindingActivity = ActivityDetailBinding.inflate(getLayoutInflater());
        setContentView(bindingActivity.getRoot());

        Toolbar toolbar = bindingActivity.toolbar;
        ...
        FloatingActionButton fab = bindingActivity.fab;
